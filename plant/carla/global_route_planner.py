...
#
# Source: github.com/carla-simulator/carla (0.9.15)
# Modified: inlined RoadOption and vector to remove agents library dependency.
...
def _vector(loc1, loc2):
    x, y, z = loc2.x - loc1.x, loc2.y - loc1.y, loc2.z - loc1.z
